...
class TokenCostProcess:
    ...
    def get_openai_total_cost_for_model(self) -> float:
        return MODEL_COST_PER_1K_TOKENS[self.model] * self.total_tokens / 1000

    def get_cost_summary(self) -> str:
        cost = self.get_openai_total_cost_for_model(self.model)
...
class CostCalcAsyncHandler(AsyncCallbackHandler):
    ...
    def on_llm_start(
        ...
        encoding = tiktoken.encoding_for_model(self.token_cost_process.model)
