...
"""
    ...
    def web_summarize_map_templete(self) -> str:
...
"""
    ...
    def web_summarize_combine_templete(self, n_chars: int = 300) -> str:
...
"""
    ...
    def web_summarize_refine_templete(self, n_chars: int = 300) -> str:
        prompt = f"""以下はとあるWebページのコンテンツです。内容を{n_chars}字程度でわかりやすく要約してください。
